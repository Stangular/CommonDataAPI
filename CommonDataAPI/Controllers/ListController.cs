...
namespace CommonDataAPI.Controllers
{
    ...
    public class ListController : Controller
    {
        ...
        // GET: api/List/5
        [HttpGet("{listNames}", Name = "Get")]
        [EnableCors("MyPolicy")]
        [Authorize(Policy = "RegisteredDataUser")]
        public IActionResult Get(List<string> listNames)
        {
            try
            {
                return Ok(_listRepo.List(listNames));
            }
            catch (System.Exception ex)
            {
            ...
            return BadRequest("Requested lists could not be returned.");
